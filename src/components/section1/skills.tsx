...
const Skills:React.FC<BackendProps> = ({active,reference,image,text,title,index}) => {
    ...
    return (
        <div className={`flex flex-col   bg-[#111c30]  my-[5%] mx-[15%] h-auto w-auto  rounded-lg shadow-xl  transition transform ease-in-out duration-700 ${active ? 'opacity-100 translate-x-0':'opacity-0 scale-[5%]'}`} ref={reference}>
